...
| T5	 | H9 e H10 |	A tela não mostra se a senha ou o email possuem requisitos obrigatórios como número mínimo de caracteres ou caracteres específicos, e também não apresenta um ícone de ajuda caso o usuário tenha dúvidas sobre o app | 3 |
| T6	 | H9 e H10 |	A tela não possui o ícone de ajuda e não mostra quais as formas de pagamento disponíveis no app | 3 |
| T9	 | H10 |	A tela não mostra as formas de avaliação do app | 2 |

## Tabela Severidade
![image](https://github.com/user-attachments/assets/f3df5e19-4bcb-4a80-9c16-9cbba8a42cf8)
